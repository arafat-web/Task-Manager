...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center justify-content-between" style="position:relative;z-index:1;">
            <div>
                <h1 class="cu-header-title"><i class="bi bi-calendar-month me-2"></i>Monthly Routines</h1>
                <p class="cu-header-sub">All your monthly recurring schedules</p>
            </div>
    ...
    <div class="cu-grid">
        ...
        <div class="cu-empty">
            <i class="bi bi-calendar3"></i>
            <h5>No monthly routines yet</h5>
            <p>Create your first monthly routine to get started.</p>
            <a href="{{ route('routines.create') }}" class="cu-btn-create">
                <i class="bi bi-plus-lg"></i> Create Monthly Routine
            </a>
        </div>
        @endforelse
    </div>
