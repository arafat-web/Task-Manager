...
@section('title', 'Monthly Routines')
...
<style>
    ...
    .monthly-header {
        background: linear-gradient(135deg, var(--routine-warning) 0%, #fd7e14 100%);
        color: white;
        border-radius: 16px;
        padding: 2rem;
        margin-bottom: 2rem;
    ...
    .routine-card:hover {
        ...
        border-color: var(--routine-warning);
    }
...
<div class="container-fluid">
    ...
    <div class="monthly-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h2 mb-2">
                    <i class="fas fa-calendar-alt me-3"></i>Monthly Routines
                </h1>
                <p class="mb-0 opacity-75">Manage your monthly recurring routines and schedules</p>
            </div>
    ...
    <nav class="breadcrumb-modern">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Monthly Routines</li>
        </ol>
    </nav>
        ...
        @empty
            <div class="col-12">
                <div class="empty-state">
                    <i class="fas fa-calendar-alt"></i>
                    <h3>No Monthly Routines Found</h3>
                    <p>You haven't created any monthly routines yet. Start by adding your first routine to organize your monthly schedule.</p>
                    <a href="{{ route('routines.create') }}" class="btn-modern btn-primary btn-lg">
                        <i class="fas fa-plus me-2"></i>Create Your First Monthly Routine
                    </a>
                </div>
            </div>
        @endforelse
