...
<div class="container-fluid">
    ...
    <div class="create-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h2 mb-2">
                    <i class="fas fa-plus me-3"></i>Create New Routine
                </h1>
                <p class="mb-0 opacity-75">Set up your daily, weekly, or monthly routine schedule</p>
            </div>
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="form-group-modern">
                            ...
                            <textarea id="description"
                                      ...
                                      rows="4"
                                      placeholder="Add more details about this routine...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="frequency-section" id="days" style="display: none;">
                        ...
                        <div class="frequency-section" id="weeks" style="display: none;">
                            <div class="section-title">
                        ...
                        <div class="frequency-section" id="months" style="display: none;">
                            <div class="section-title">
                                <i class="fas fa-calendar-alt" style="color: var(--routine-primary);"></i>
                                Select Months
                            </div>
