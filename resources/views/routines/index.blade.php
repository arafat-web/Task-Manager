    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="kanban-column">
                ...
                @endforelse
                <div class="mt-3">
                    <a href="{{ route('routines.showWeekly') }}" class="btn btn-secondary">View All Weekly Routines</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="kanban-column">
                ...
                @endforelse
                <div class="mt-3">
                    <a href="{{ route('routines.showMonthly') }}" class="btn btn-secondary">View All Monthly Routines</a>
                </div>
            </div>
        </div>
    </div>
