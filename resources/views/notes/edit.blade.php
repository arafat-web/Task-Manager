...
<div class="container-fluid px-4">
    ...
    <div class="edit-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-2">
                    <i class="fas fa-edit me-3"></i>Edit Note
                </h1>
                <p class="mb-0 opacity-90">Update your note content and settings</p>
            </div>
            <div class="col-md-4 text-md-end">
                <a href="{{ route('notes.show', $note->id) }}" class="btn btn-light me-2">
                ...
                <div class="form-card-body">
                    <form action="{{ route('notes.update', $note->id) }}" method="POST" id="note-form">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{ old('date', $note->date ? $note->date->format('Y-m-d') : '') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('notes.show', $note->id) }}" class="btn btn-outline-secondary">
                    ...
                    <div class="danger-zone">
                        ...
                        <form action="{{ route('notes.destroy', $note->id) }}" method="POST"
                              onsubmit="return confirm('Are you absolutely sure you want to delete this note? This action cannot be undone.')"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set initial content
    const initialContent = `{!! addslashes(old('content', $note->content)) !!}`;
    ...
    let tags = @json(old('tags', $note->tags ?? []));
    ...
    window.saveDraft = function() {
        ...
        localStorage.setItem('note_edit_draft_{{ $note->id }}', JSON.stringify(draftData));
    ...
    document.getElementById('note-form').addEventListener('submit', function() {
        localStorage.removeItem('note_edit_draft_{{ $note->id }}');
    });
});
</script>
@endsection
